...
var (
	...
	rubrikLinuxFilesetCapacityLocalUsed = prometheus.NewGaugeVec(
		prometheus.GaugeOpts{
			Name: "rubrik_linux_fileset_capacity_local_used_bytes",
			Help: "Local storage consumption for Linux Fileset snapshots.",
		},
		[]string{
			"clusterName",
			"objectName",
	...
	rubrikLinuxFilesetCapacityArchiveUsed = prometheus.NewGaugeVec(
		prometheus.GaugeOpts{
			...
			Help: "Archive storage consumption for Linux Fileset snapshots.",
		},
		[]string{
			"clusterName",
			"objectName",
